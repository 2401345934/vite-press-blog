...
module.exports = [
  ...
  { text: "工程师基本能力", link: "/http/http-https/", activeMatch: '/http/' },
  { text: "算法&数据结构", link: "/data-structures-algorithms/introduction/", activeMatch: '/data-structures-algorithms/' },
  { text: "软能力", link: "/soft-power/asking-questions/", activeMatch: '/soft-power/' },
  { text: "工作工具", link: "/tool/compressed-image/", activeMatch: '/tool/' },
  { text: "vite-component文档", link: "/my-vite-component/introduce/", activeMatch: '/my-vite-component/' },
]