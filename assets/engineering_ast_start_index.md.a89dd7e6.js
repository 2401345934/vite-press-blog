import{_ as l,o as t,c as o,b as s,w as r,d as n,e as c,a as i,r as a}from"./app.dec15874.js";const v=JSON.parse('{"title":"AST（抽象语法树） 到底是什么？","description":"","frontmatter":{"createTime":"2022/11/12","tag":"工程化,AST"},"headers":[],"relativePath":"engineering/ast/start/index.md","lastUpdated":1668240726000}'),u={name:"engineering/ast/start/index.md"},A=n("h1",{id:"ast-抽象语法树-到底是什么",tabindex:"-1"},[c("AST（抽象语法树） 到底是什么？ "),n("a",{class:"header-anchor",href:"#ast-抽象语法树-到底是什么","aria-hidden":"true"},"#")],-1),C=i(`<p>抽象语法树（Abstract Syntax Tree，AST）是源代码语法结构的一种抽象表示，它以树状的形式表现编程语言的语法结构，树上的每个节点都表示源代码中的一种结构。在代码语法的检查、代码风格的检查、代码的格式化、代码的高亮、代码错误提示、代码自动补全等等场景均有广泛的应用。</p><p>以前我们在做小学语文题时，经常会做到的一种题型就是在一句话中找出不恰当的部分，比如：&quot;你是猪，&quot;</p><p>解题方法通常是：</p><ul><li>第一步：找出语句中的主语、谓语、宾语</li><li>第二步：找出语句中的形容词、动词、标点符号等进行分析</li></ul><p>如果将其程序化，我们按照上面的方法可以先将其进行拆分成这样：</p><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">[</span></span>
